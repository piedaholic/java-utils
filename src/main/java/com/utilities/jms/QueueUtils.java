...
public class QueueUtils {
    ...
    public static boolean writeToQ(String outChar, String message, Queue queue, QueueConnectionFactory factory,
	    String refno, String callerId, String callerPswd) {
    ...
    public static synchronized String[] getMsgFromQ(QueueConnectionFactory queueConnectionFactory, Queue queue,
	    Queue backUpQ, String callerId, String callerPswd) {
    ...
    public static void deleteMsgFrmQ(QueueConnectionFactory queueConnectionFactory, Queue backUpQ, String corrId,
	    String callerId, String callerPswd) {
	QueueConnection queueConnection = null;
	QueueSession queueSession = null;
	QueueReceiver queueReceiver = null;
	try {
    ...
    public static boolean writeFileToQ(String message, Queue queue, QueueConnectionFactory factory, String refno,
	    String callerId, String callerPswd) {
	QueueSession session = null;
	QueueSender sender = null;
	QueueConnection qConnection = null;
    ...
    public void sendMsgToQ(Object messageObj, String p_correlationID, String p_JMS_QUEUE_ICF,
	    String p_JMS_QUEUE_PROVIDER_URL, String p_JMS_QUEUE_SECURITY_PRINCIPAL,
	    String p_JMS_QUEUE_SECURITY_CREDENTIALS, String p_JMS_QCF, String p_JMS_QUEUE_NAME,
	    String p_JMS_Q_ACKNOWLEDGE, String p_JMS_Q_TRANSACTION, int p_JMS_Q_DELIVERY_OPT, int p_JMS_Q_TIME_TO_LIVE,
	    int p_JMS_Q_PRIORITY, String callerID, String callerPswd) throws Exception {
	...
	try {
	    ...
	    l_queueSender.send((Message) jmsMessage, p_JMS_Q_DELIVERY_OPT, p_JMS_Q_PRIORITY,
    ...
    public void sendMsgsToQ(Map<?, ?> p_Msgs, String p_correlationID, String p_JMS_QUEUE_ICF,
	    String p_JMS_QUEUE_PROVIDER_URL, String p_JMS_QUEUE_SECURITY_PRINCIPAL,
	    String p_JMS_QUEUE_SECURITY_CREDENTIALS, String p_JMS_QCF, String p_JMS_Q_ACKNOWLEDGE,
	    String p_JMS_Q_TRANSACTION, int p_JMS_Q_DELIVERY_OPT, int p_JMS_Q_TIME_TO_LIVE, int p_JMS_Q_PRIORITY,
	    String callerId, String callerPswd) throws Exception {
	boolean l_transacted = false;
	if ("true".equalsIgnoreCase(p_JMS_Q_TRANSACTION)) {
	    l_transacted = true;
	}
	...
	try {
		...
		l_textMessage.setJMSCorrelationID(p_correlationID);
		l_queueSender.send(l_textMessage, p_JMS_Q_DELIVERY_OPT, p_JMS_Q_PRIORITY, (long) p_JMS_Q_TIME_TO_LIVE);
    ...
    public String readMsgFromQ(String p_correlationID, String p_JMS_QUEUE_ICF, String p_JMS_QUEUE_PROVIDER_URL,
	    String p_JMS_QUEUE_SECURITY_PRINCIPAL, String p_JMS_QUEUE_SECURITY_CREDENTIALS, String p_JMS_QCF,
	    String p_JMS_QUEUE_NAME, String p_JMS_Q_ACKNOWLEDGE, String p_JMS_Q_TRANSACTION, String callerId,
	    String callerPswd) throws Exception {
