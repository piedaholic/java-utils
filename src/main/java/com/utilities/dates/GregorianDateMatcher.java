...
public class GregorianDateMatcher {
	...
	private static Pattern TIMESTAMP_PATTERN = Pattern
			.compile("(00|0[0-9]|1[0-9]|2[0-3]):([0-9]|[0-5][0-9]):([0-9]|[0-5][0-9])$");
	...
	public static String timestampPattern = "(00|[0-9]|1[0-9]|2[0-3]):([0-9]|[0-5][0-9]):([0-9]|[0-5][0-9])$";
