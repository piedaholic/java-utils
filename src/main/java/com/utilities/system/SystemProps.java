...
public class SystemProps {
  ...
  /**
   * Update env val with path.
   *
   * @param key the key
   * @param sysProps the sys props
   * @param appProps the app props
   * @return the properties
   */
  public static Properties updateEnvValWithPath(
      String key, Properties sysProps, Properties appProps) {
    String value = "";
