...
public class MailUtils {
    public static boolean enableMail(String toAddr, String toBeEmailed, String outDir, String fileName, String fromAddr,
	    String srvrIpAddress) throws Exception {
	...
	try {
		...
		mailProcess = eMailSenderSMTPORSMTPS(fromAddr, toAddr, subject, body, filePath, srvrIpAddress);
	    }
	} finally {
    ...
    private static boolean eMailSenderSMTPORSMTPS(String from, String to, String mailSubject, String mailBody,
	    String filePath, String ipAddress) throws Exception {
