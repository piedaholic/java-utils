...
public class TwoDSort {
	...
	public int compare(Object o1, Object o2) {
		...
		if (this.ascndg == 1) {
			...
			return ((String[]) ((String[]) o1))[this.columnIndex]
				.compareTo(((String[]) ((String[]) o2))[this.columnIndex]);
		    ...
		    return ((String[]) ((String[]) o2))[this.columnIndex]
			    .compareTo(((String[]) ((String[]) o1))[this.columnIndex]);
		} else if (this.dataType.equals("DATE")) {
		    sdt1 = ((String[]) ((String[]) o1))[this.columnIndex];
		    dt1 = Date.valueOf(sdt1);
		    sdt2 = ((String[]) ((String[]) o2))[this.columnIndex];
